...
Unfortunately we could not do reliability since there were no datasets with MPG and there were too many engines to manually put in data for, but we found better categories to pick from.
## Dataset
### Cars Datasets (2025)
...
## UML Diagram
![Unit 3 UML Diagram](<Copy of (Unit 3) UML Diagram.jpg>)
## Description
